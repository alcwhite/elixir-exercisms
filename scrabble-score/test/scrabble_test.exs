defmodule ScrabbleTest do
  ...
  test "double word" do
    assert Scrabble.score("alacrity", :double) == 26
  end

  test "triple word" do
    assert Scrabble.score("alacrity", :triple) == 39
  end

  test "double letter" do
    assert Scrabble.score("alacrity", :double, "c") == 16
  end

  test "triple letter" do
    assert Scrabble.score("alacrity", :triple, "c") == 19
  end

  test "triple letter double word" do
    assert Scrabble.score("alacrity", :double, :triple, "c") == 38
  end
end
